...
public class E_Logical {
	 ...
	 * 논리연산한 결과마저도 논리값임 
	 * 
	 * 논리값 && 논리값 : (and, 그리고) 왼쪽, 오른쪽 둘 다 true일 경우
	 * 논리값 || 논리값 : (or, 또는) 왼쪽 , 오른쪽 둘 중 하나라도 true일 경우만 true
	 */
...
// 		e.method2();
	...
	public void method1() {
		...
		System.out.println(number + "1부터 100 사이의 값인가요? : " + result);
...
//		result1 = (a >= 65) && (a <= 90);
//		
//		System.out.println("문자 "+ch+"가 대문자인가요? : "+result1);
