...
public class Variable {
	...
	public void printValue() {
		// 변수를 사용하지 않으면
		System.out.println(10 * 2 * 3.141592); //원의 둘레 = 반지름 * 2
	...
	public void variableTest() {
		 ...
		 * 
		 * 변수에 처음으로 값을 저장하는 것
		 * '='는 오른쪽 데이트를 왼쪽의 변수에 대입(저장)하는 연산자이다.
		 */
...
//		bNum = 128; // 에러 발생 -> 오버플로우(Overflow)
		...
		dNum = 3.14d; // 숫자 뒤에 D또는 d를 입력해야 한다.
		
		// 창조 자료형 : 4byte, 기본형을 제외한 나머지(클래스)
		String name = "이한주";
		...
		int NUMBER;
		int Number;
//		String number; // 자료형의 달라도 변수명이 같으면 에러 발생
