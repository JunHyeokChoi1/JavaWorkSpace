...
​
    ...
    */
    public void practice7() {
    	...
    	if (!Id2.equals(Id)) System.out.println("아이디가 틀렸습니다");
        else if (!(pw == 1234)) System.out.println("비밀번호가 틀렸습니다");
...
​
    ...
    public void practice9() {
    	...
    	if ("+".equals(mark)) System.out.println(num1 + "+" + num2 + "=" + (num1+num2));
    	else if ("-".equals(mark)) System.out.println(num1 + "-" + num2 + "=" + (num1-num2));
    	else if ("*".equals(mark)) System.out.println(num1 + "*" + num2 + "=" + (num1*num2));
    	else if ("/".equals(mark)) System.out.println(num1 + "/" + num2 + "=" + (num1/num2));
    	else if ("%".equals(mark)) System.out.println(num1 + "%" + num2 + "=" + (num1%num2));
    	else System.out.println("잘못 입력하였습니다. 프로그램을 종료합니다.");
    }
    /*
...
​
    ...
    public void practice10() {
    	...
    	if(num1==1) System.out.println("입력 메뉴입니다.");
    	else if(num1==2) System.out.println("수정 메뉴입니다.");
    	else if(num1==3) System.out.println("조회 메뉴입니다.");
    	else if(num1==4) System.out.println("삭제 메뉴입니다.");
    	else if(num1==9) System.out.println("프로그램이 종료됩니다.");
...
​
    ...
    public void practice11() {
        ...
        if (result >= 70 && d1 >= 14) {
        System.out.println("중간고사 점수(30) : " + a1);
        System.out.println("기말 고사 점수(30) : " + b1);
        System.out.println("과제 점수(30) : " + c1);
        System.out.println("출석 점수 : " + d1);
        System.out.println("총점: " + result);
        System.out.println("PASS");}
        else if (result < 70 && d1 >= 14) {System.out.println("FAIL [점수 미달] (총점" + result + ")");}
        else if (result >= 70 && d < 14) {System.out.println("FAIL [출석 횟수 부족] (" + d + "/20)");}
        else {
