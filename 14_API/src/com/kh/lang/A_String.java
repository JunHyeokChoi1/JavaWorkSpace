...
//		a.method2();
	...
	public void method2() {
		...
		//      - 문자열의 beginIndex 위치에서부터 끝까지의 문자열을
		//         새로 생성해서 리턴
		//    substring(int beginIndex, int endIndex) : String
		//      - 문자열의 beginIndex 위치에서부터 endIndex-1 까지의
		//         새로운 문자열을 새로 생성해서 리턴
		...
		//    - 문자열에서 old 문자를 new 문자로 변경된 새로운 문자열을
		//       생성해서 리턴
	...
	public void method5() {
		...
		// split(String regex) : 입력받은 구분자로 문자열을 분리해서
		//                       문자열의 배열로 담아서 리턴
