...
//		b.method3();
	...
	public void method1() {
		...
		System.out.println("isAfter : " + now.isAfter(plusDays)); //오늘이 해당날짜 보다 이후인가?
		System.out.println("isBefore : " + now.isBefore(plusDays)); // 오늘이 해당날짜 보다 이전인가?
	...
	public void method3() {
		...
		/*
		 * DateTimeFormatter
		 * - 날짜와 시간을 포맷팅(Formatting)된 문자열을 변환하는 메서드를 제공하는 클래스
		 */
		...
		System.out.println(today.format(DateTimeFormatter.ISO_DATE_TIME));
