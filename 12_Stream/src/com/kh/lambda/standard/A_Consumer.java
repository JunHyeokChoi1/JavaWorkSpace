...
/*
 * 표준 함수적 인터페이스
 * - 자바 8부터 빈번히 사용되는 함수적 인터페이스는 java.util.function 
 *   표준 API 패키지로 제공
 * - 자바 8부터 추가되거나 변경된 API는 이 표준 함수적 인터페이스들을
 *   매개 타입으로 사용
 * - 용도에 따라 크게 Consumer, Supplier, Function, Operator, 
 *   Predicate로 구분
 *   
 * Consumer
 * - Consumer 함수적 인터페이스는 리턴 값이 없는 accept() 추상 메서드를
 *   가지고 있다.
