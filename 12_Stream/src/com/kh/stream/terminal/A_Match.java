 ...
 * 
 * allMatch : 모든 요소들이 매게 값으로 주어진 Predicate의 조건을 만족하는지 조사
 * 
...
//		a.method1();
	...
	public void method2() {
		...
		result = students.stream().allMatch(student -> student.equals("여자") && student.getAge() >10 );
		System.out.println(result);
