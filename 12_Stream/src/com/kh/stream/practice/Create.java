...
//		c.method2();
	...
	public void method1() {
		// 첫 번째 매개 값 ~ 두 번째 매개 값 이전까지의 값을
		// 요소로 가지는 스트림 객체를 생성
		IntStream stream = IntStream.range(1, 10);
		int sum = stream.sum();
		System.out.println("range의 sum : " + sum);
		
		// 첫 번째 매개 값 ~ 두 번째 매개 값 까지의 값을
		// 요소로 가지는 스트림 객체를 생성
	 ...
	 * - 각 스트림(Stream, IntStream, ...)의 
	 *   of(배열) 메서드로 스트림을 생성한다.
	 * */
	public void method2() {
