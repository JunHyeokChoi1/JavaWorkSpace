...
//		setPrice(price);
		...
		super.pCode = pCode;  // 부모가 default - 같은 패키지에 있어야만 접근이 가능
		...
		*/
		 ...
		 * 	- 부모 클래스에서 setter 메서드를 제공하는 자식 객체에서 부모의 setter 메서드를 통해서 필드의 초기화가 가능
		*/
